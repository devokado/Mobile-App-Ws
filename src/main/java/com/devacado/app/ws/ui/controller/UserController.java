package com.devacado.app.ws.ui.controller;

import com.devacado.app.ws.exceptions.UserServiceException;
import com.devacado.app.ws.ui.model.request.UpdateUserDetailsRequestModel;
...
public class UserController {
    ...
    public UserRest updateUser(@PathVariable String userId, @Valid @RequestBody UpdateUserDetailsRequestModel userDetails) {
        ...
        storedUserDetails.setFirstName(userDetails.getFirstNam());
